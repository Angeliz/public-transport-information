...
public class SinglyList<String> extends Object{
	...
	public SinglyList(String data,Node next){  				//构造结点
		this.data=data;
		this.next=next;
	}
	...
	public SinglyList(){                          							//构造空单链表
		this.head=new Node (null,null);		      			//创造头结点，data和next的值均为null	
	}
	...
	public String get(int i){					  							//返回第i个元素，若i越界，则返回null
		...
		return (i>=0 && p!=null)?(String)p.data:null;
	}
	...
	//插入
	public Node insert(int i,String x){
		if(x==null){
			throw new NullPointerException("x==null");      				//抛出空对象异常
		}
		Node front=this.head;									//指向头结点
	...
	public String remove(int i){											//删除第i个元素，若i越界，则返回null
		...
		if(i>=0&&front.next!=null){											//若front的后继节点存在，就删除
			String old=(String) front.next.data;
